...
internal object AryehArt {
    ...
    // Left and right only — the middle tuft used to sit dead centre between the two spikes
    // that flank the top, which read as a seventh, smaller spike of its own.
    const val MANE_FRONT =
        "M-12.0,-12.0 Q-15.4,-20.2 -12.9,-24.3 Q-8.1,-24.0 -3.2,-16.6 A17.0,17.0 0 0 0 -12.0,-12.0 Z M3.2,-16.6 Q8.1,-24.0 12.9,-24.3 Q15.4,-20.2 12.0,-12.0 A17.0,17.0 0 0 0 3.2,-16.6 Z"
    const val SKULL =
